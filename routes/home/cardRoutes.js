...
router.post("/home/product/add-to-card",customerMiddleware, cardController.add_to_card);
router.get(
  "/home/product/get-card-product",customerMiddleware,
  cardController.get_card_products
);
router.delete(
  "/home/product/delete-all-cart-product/:userId",customerMiddleware,
...
router.post("/home/product/add-to-wishlist",customerMiddleware, cardController.add_wishlist);
router.get(
